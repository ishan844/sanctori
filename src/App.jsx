    ...
    return (
        <div ref={containerRef} className="relative w-full bg-tertiary" style={{ height: '100dvh', minHeight: '100vh', marginTop: '-1px' }}>
            <div className="w-full overflow-hidden flex items-center justify-center relative" style={{ height: '100dvh', minHeight: '100vh' }}>
                ...
                {/* Content Container */}
                <div className="relative z-20 max-w-[100rem] mx-auto w-full px-6 lg:px-[84px] h-full flex flex-col lg:flex-row items-center lg:items-start justify-between py-24 lg:pb-32 lg:pt-32">
                    ...
                    <motion.div
                        style={{ opacity: detailsOpacity, pointerEvents }}
                        className="w-full lg:w-[42%] flex flex-col items-start text-left z-30 mt-8 lg:mt-0 lg:pt-16 lg:pr-4"
                    >
                        {/* Category / Subtitle */}
                        ...
                        {/* Footer specs */}
                        <div className="w-full flex flex-col pt-8 border-t border-secondary/20">
